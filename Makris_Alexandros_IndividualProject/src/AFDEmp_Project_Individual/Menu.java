...
public class Menu {
	...
	private void print() {
		StringBuilder sb = new StringBuilder();
                sb.append("\n\n");
		sb.append("\t\t\t\t                       _|      _|            _|                      \n");
                sb.append("\t\t\t\t   _|_|_|  _|  _|_|  _|_|_|_|        _|_|_|  _|    _|_|      _|_|_| \n");
                sb.append("\t\t\t\t _|    _|  _|_|        _|      _|  _|        _|  _|_|_|_|  _|_|    \n");
                sb.append("\t\t\t\t _|    _|  _|          _|      _|  _|        _|  _|            _|_|  \n");
                sb.append("\t\t\t\t   _|_|_|  _|            _|_|  _|    _|_|_|  _|    _|_|_|  _|_|_|   \n");
                sb.append("\t\t\t\t\t\t\t\t\t\t\t\t v0.17\n");
                sb.append("");
		...
		for (int i = 0; i < this.itemList.size(); i++){
                        sb.append("\n");
			sb.append("\t\t\t\t\t\t\t" + (i + 1) + "... " + this.itemList.get(i).getLabel());
                } 
